...
const navItems = [
  ...
  { path: '/jobs', label: 'Jobs', icon: 'M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2M3.6 9h16.8a1 1 0 011 1v8.4a1.6 1.6 0 01-1.6 1.6H4.2a1.6 1.6 0 01-1.6-1.6V10a1 1 0 011-1z' },
      ...
      <aside className={`sidebar ${sidebarOpen ? 'open' : 'collapsed'}`}>
        <div className="sidebar-header">
          <div className="logo">
            ...
            {sidebarOpen && <span className="logo-text">RecruitAI</span>}
          </div>
